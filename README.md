...
1. 点击一键部署按钮
   ...
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FPretellKing%2Fvercel-proxy&project-name=vercel-proxy&repository-name=vercel-proxy&root-directory=src)
